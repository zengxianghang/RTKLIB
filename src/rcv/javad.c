...
{
    rtktrace(2,"javad CA not supported\n");
...
{
    rtktrace(2,"javad IA not supported\n");
...
{
    if (!checksum(raw->buff,raw->len)) {
        rtktrace(2,"javad IE checksum error: len=%d\n",raw->len);
        return -1;
    }
    if (raw->len<129) {
        rtktrace(2,"javad IE length error: len=%d\n",raw->len);
        return -1;
    }
...
{
    rtktrace(2,"javad ED not supported\n");
...
{
    rtktrace(2,"javad cd not supported\n");
...
{
    rtktrace(2,"javad id not supported\n");
